...
data AST = Unary Unary AST | Binary Binary AST AST | Ass_ String AST | Id_ String deriving (Eq, Ord, Show)
data Unary = Cos_ | Sin_ | Length_ | Abs_ | Neg_ deriving (Eq, Ord, Show)
data Binary = Mul_ | Add_ | Sub_ | Div_ deriving (Eq, Ord, Show)
